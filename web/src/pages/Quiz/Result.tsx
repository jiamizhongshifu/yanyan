 ...
 *
 * 漏斗底部:用户看到自己的初步指数后,展示登录后能解锁什么(拍照火分 / 30 天档案 / 个体发物清单)
 */
...
const UNLOCKED_FEATURES = [
  ...
  {
    title: '30 天体质档案 PDF',
    body: '完整 30 天 Yan-Score 趋势 + 个体发物 + 体检对照(若上传)+ 引用,可下载 / 分享。'
  }
];
  ...
  return (
    <main className="min-h-screen bg-paper px-6 pt-12 pb-20" data-testid="quiz-result">
      ...
      <section className="mt-6 rounded-3xl bg-white px-6 py-8 text-center">
        ...
        <p className="mt-1 text-xs text-ink/40">基于 {Math.round(index.completeness * 100)}% 数据完整度</p>
      </section>
