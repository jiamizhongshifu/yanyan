...
import { clearDekCacheForTesting, encryptField } from '../../server/crypto/envelope';
import {
...
import type { ActivitySnapshot, DailyMealAggregate, EnvSnapshot } from '../../server/services/score/parts';
